...
og_normalized_profiles, og_early_sorted = find_hox_units(og_hidden_unit_history, og_living_cells[:60], phase = (0, 20))
...
# late_phen, late_loss = progressive_knockout_loss(og_model, og_early_sorted[::-1], grid, env, params)

# plt.figure(figsize = (8, 5))
# plt.plot(np.log10(early_loss), linewidth = 2, label = "Hox units")
# plt.plot(np.log10(late_loss), linewidth = 2, label = "Non-hox units")
...
# for pos in ['right', 'top']:
#     plt.gca().spines[pos].set_visible(False)
# filename = f'./models/{og_model_name}/early_vs_late.png'
# plt.savefig(filename, bbox_inches = 'tight')
# plt.show()

# plt.imshow(late_phen)
# plt.axis('off')
# plt.tight_layout()
# plt.savefig(f'./models/{og_model_name}/non_hox_knockout.png', bbox_inches = 'tight')

# save = f'./models/{og_model_name}/early_hox_spatial.png'
# visualize_hidden_unit_stills(og_hidden_unit_history, units = og_early_sorted[:5], filename = save, dims = (15, 10))
...
# state_histories_sn = np.zeros((10, 100, 50, 50, 16))
# state_histories_ns = np.zeros((10, 100, 50, 50, 16))
...
# for pos in ['right', 'top']:
#     plt.gca().spines[pos].set_visible(False)
# filename = f"conserved_genes_by_iteration.png"
# plt.savefig(filename, bbox_inches = 'tight')
# plt.show()
...
# _, og_mid_sorted = find_hox_units(hidden_unit_history_lb, living_cells_lb[:60], phase = (21, 34))
# _, og_late_sorted = find_hox_units(hidden_unit_history_lb, living_cells_lb[:60], phase = (35, 60))
